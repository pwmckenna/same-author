...
describe('same-author', function () {
    it('tests a module that is written by the author of this repo', function () {
    ...
    it('tests a module that is not written by the author of this repo', function () {
    ...
    it('tests a module that is written by the author of another repo', function () {
    ...
    it('tests a module that is not written by the author of another repo', function () {
